...
<head>
  ...
  <title></title> 
   <!--styles-->   
   <link rel="stylesheet" href="<?php echo auto_version('/calendar/styles/calendar.css'); ?>" type="text/css" media="screen" />
   <link rel="stylesheet" href="<?php echo auto_version('/calendar/styles/print.css'); ?>" type="text/css" media="print" />
   <link rel="stylesheet" href="<?php echo auto_version('/calendar/styles/nav.css'); ?>" type="text/css" />
       ...
       -->
        ...
        <div class="clearfix">
		   ...
		   <div  style="float:right; display:inline-block;max-width:990px; box-sizing:border-box" id="icons">
			   <div name="teamdata" class="clearfix" id="teamSelection">
				   <div class="clearfix">
					   <div class="iconrow">      
			...
			<div class="a clearfix" >   
			  ...
			  <span style="padding-top:12px;float:left">Assignment: &nbsp;</span>
			   ...
			   <!-- <div class="iconrow">
				...
				<!-- Partially Completed Job, Service Required - half-filled circle -->
				<div class="iconrow">
				...
				<div class="iconrow">
				   <!--  <input style="float:left" type="checkbox" id="select-14" name="inst-invoice" value="t14" checked="checked">-->
					<div class="box-label ic-i-comp" id="l14"> Collect</div>
				</div>
        ...
        <!-- <div class="row">
          ...
          <div class="row">
             <div id="btnPrev"><img  id="prevMonth" src="assets/prev-mo.png"></div>              
              <div style="width:49.5%; display:inline-block; text-align:center; margin: 0px; box-sizing:border-box;"><span class="cursive" id="mo"><!-- e.g., ordinal="12" for december --></span> <span class="year cursive" id="yr" ordinal=""><!-- e.g., 2016, etc --></span></div>
...
/*    No More "Completed" status.  Simply Remove from Calendar.  See: III., Below
	 ...
	 */
	 ...
	 else if( $(obj).attr("id") === 'delete' || $(obj).attr("id") === 'completed')
	 {
		 ...
		 if( $(editableLI).hasClass("due") ) { 
				 //remove the styling for overdue AND remove it from the overdue listing.
				 unsetOverDueJob();
				/* $(editableLI).removeClass("due"); }
			 	$(editableLI).addClass( 'completed' );*/
		 }
		...
		else if( $(editableLI).hasClass("completed") !== true) { 
...
function printWindow(){
	$( "#print" ).removeClass( "hide" );
	 ...
	 printWindow.document.write('<html><head><title>Print Calendar</title><link rel="stylesheet" href="<?php echo auto_version('styles/print.css'); ?>" type="text/css" media="all" /><link rel="stylesheet" href="assets/icomoon/style.css">');

...
function printWindow(){
	$( "#print" ).removeClass( "hide" );
	 ...
	 printWindow.document.write('<html><head><title>Print Calendar</title><link href="styles/print_1.css" media="all" rel="stylesheet" /> <link rel="stylesheet" href="assets/icomoon/style.css">');
...
function onloadSetOverdueDisplay(){
	...
	if( isEmpty(overdueJobs) === false ){
		...
		$('#OverDueJobsList').append('<p>Excellent! All WIPs are On-Schedule.</p>');

...
//error_reporting(E_ALL);
			...
			} elseif ($_SESSION['user']['role'] === 'admin' || $_SESSION['user']['role'] === 'mgr'){
...
<!-- Row having search, welcome user, select company calendar form in left column, and all user action btns in the right column as a row-->

<!-- main user controls panel row -->
<div class="clearfix">

	<!-- left column -->
   <div class="forty-pct"><br/>         
